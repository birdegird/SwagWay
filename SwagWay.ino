...
void loop() {
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
        ...
        if (!initialSetup)
        {          
          initialYaw = ypr[0] * 180/M_PI;
          initialPitch = ypr[1] * 180/M_PI;
          initialRoll = ypr[2] * 180/M_PI;
          ...
          initialSetup = true;
            ...
            Serial.print("ypr\t");
            Serial.print((ypr[0] * 180/M_PI) - initialYaw);
            Serial.print("\t");
            Serial.print((ypr[1] * 180/M_PI) - initialPitch);
            Serial.print("\t");
            Serial.println((ypr[2] * 180/M_PI) - initialRoll);
        #endif
        ...
        float correction = (ypr[2] * 180/M_PI) - initialRoll;
